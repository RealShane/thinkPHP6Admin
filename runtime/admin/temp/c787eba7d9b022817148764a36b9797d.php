<?php /*a:3:{s:73:"D:\WorkSpace\WebServer\code_up\app\admin\view\generate\config\config.html";i:1593275398;s:63:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_meta.html";i:1579946888;s:65:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_footer.html";i:1579951300;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <article class="Hui-admin-content clearfix">
        ...
        <div class="panel mt-20">
            <div class="panel-body">
                <div class="clearfix">
					<span class="f-l">
				        <a href="/ETSLP.php/Config/export_file" class="btn btn-primary radius">
                ...
                <div class="mt-20 clearfix">
                    <table id='dataSingleSet' class="table table-border table-bordered table-bg table-hover table-sort">
                        <thead>
                            <tr>
                                <th scope="col" colspan="7">系统配置表</th>
                            </tr>
                            <tr class="text-c">
                                <th></th>
...
<script src="/assets/js/admin/generate/config/config.js"></script>
