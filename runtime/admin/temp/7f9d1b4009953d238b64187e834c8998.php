<?php /*a:3:{s:69:"D:\WorkSpace\WebServer\code_up\app\admin\view\generate\user\user.html";i:1593275452;s:63:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_meta.html";i:1579946888;s:65:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_footer.html";i:1579951300;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <article class="Hui-admin-content clearfix">
                    ...
                    <span class="col-xs-8 form-item-control">
                        <span class="select-box">
                            <select id="searchKey" class="select">
                                <option value='id'>自增id</option><option value='openid'>用户openId</option><option value='name'>真实姓名</option><option value='phone'>电话</option><option value='nickname'>用户昵称</option><option value='headimgurl'>用户头像</option><option value='sex'>性别(0:未知1:男2:女)</option><option value='province'>省</option><option value='city'>市</option><option value='country'>国家</option><option value='create_time'>创建时间</option><option value='update_time'>更新时间</option><option value='status'>状态(0停用1启用)</option>
                            </select>
                        </span>
                    </span>
                </div>
        ...
        <div class="panel mt-20">
            <div class="panel-body">
                <div class="clearfix">
					<span class="f-l">
				        <a href="/ETSLP.php/User/export_file" class="btn btn-primary radius">
                ...
                <div class="mt-20 clearfix">
                    <table id='dataSingleSet' class="table table-border table-bordered table-bg table-hover table-sort">
                        <thead>
                            <tr>
                                <th scope="col" colspan="15">用户表</th>
                            </tr>
                            <tr class="text-c">
                                <th></th>
                                <th id='id'>自增id</th><th id='openid'>用户openId</th><th id='name'>真实姓名</th><th id='phone'>电话</th><th id='nickname'>用户昵称</th><th id='headimgurl'>用户头像</th><th id='sex'>性别(0:未知1:男2:女)</th><th id='province'>省</th><th id='city'>市</th><th id='country'>国家</th><th id='create_time'>创建时间</th><th id='update_time'>更新时间</th><th id='status'>状态(0停用1启用)</th>
                                <th>操作</th>
                            </tr>
                        </thead>
                        <tbody id='dataRoom'>
...
<script src="/assets/js/admin/generate/user/user.js"></script>
