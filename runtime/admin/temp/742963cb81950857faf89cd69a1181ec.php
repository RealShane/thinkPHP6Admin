<?php /*a:3:{s:81:"D:\WorkSpace\WebServer\code_up\app\admin\view\auth\admin_auth_group\add_edit.html";i:1593402548;s:63:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_meta.html";i:1593404073;s:65:"D:\WorkSpace\WebServer\code_up\app\admin\view\public\_footer.html";i:1593394126;}*/ ?>
	...
	<div class="panel">
		<div class="panel-body">
			<form class="form form-horizontal" id="form-admin-add">
				...
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3">组名</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" id="name">
					</div>
				</div>
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3">赋予访问权限</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<div class="skin-minimal" id="rules"></div>
					</div>
				</div>
				<div class="row clearfix">
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" id="update_time">
					</div>
				</div>
...
<script src="/assets/js/admin/admin_auth_group/add.edit.js"></script>
</body>
</html>
