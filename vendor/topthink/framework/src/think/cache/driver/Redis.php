...
class Redis extends Driver
{
     ...
     * @return mixed
     */
    public function redis_len($name = null)
    {
     ...
     * @return mixed
     */
    public function redis_pop($name = null)
    {
    ...
    /**redis 入队操作
     * @param $name 队列名
     * @param null $data 队列数据
     * @return mixed
     */
    public function redis_push($name, $data = null)
    {
        return $this->handler->rpush($name, $data);
    }
     ...
     * @return int
     */
    public function redis_set_push($name, $data = null)
    {
        return $this->handler->sAdd($name, $data);
    }
     ...
     * @return int
     */
    public function redis_set_sMembers($name, $data = null)
    {
