$(document).ready(function(){
                                ...
                                layui.each(thisData, function(index, key){
                                    arr.push(
                                        "<tr>" +
                                            ...
                                            "<td style='text-align: center'>" + key['password'] + "</td>" +
                                            "<td style='text-align: center'>" + key['password_salt'] + "</td>" +
                                            "<td style='text-align: center'>" + key['last_login_ip'] + "</td>" +
                                            "<td style='text-align: center'>" + key['last_login_time'] + "</td>" +
                                            "<td style='text-align: center'>" + key['create_time'] + "</td>" +
                                            "<td style='text-align: center'>" + key['update_time'] + "</td>" +
    ...
    $("#add").click(function(){
        layer_show('添加','/' + FILE + '/AdminView/userAddEdit?id=-1',800,500);
    })
    $("#batchDelete").click(function(){
        ...
        $.ajax({
            type : "POST",
            contentType: "application/x-www-form-urlencoded",
            url : '/' + FILE + '/AdminUser/batchDeleteData',
            data : {
                ids:ids
            },
            success : function(res) {
...
function edit(id) {
    ...
    layer_show('编辑','/' + FILE + '/AdminView/userAddEdit?id='+id,800,500);
}
