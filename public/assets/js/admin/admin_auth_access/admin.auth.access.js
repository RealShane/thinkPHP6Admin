$(document).ready(function(){
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            url : '/' + FILE + '/AdminAuthAccess/seeAll',
    ...
    $("#add").click(function(){
        layer_show('添加','/' + FILE + '/AdminAuthAccess/viewAddEdit?id=-1',800,500);
    })
    $("#batchDelete").click(function(){
        ...
        $.ajax({
            type : "POST",
            contentType: "application/x-www-form-urlencoded",
            url : '/' + FILE + '/AdminAuthAccess/batchDeleteData',
            data : {
                ids:ids
            },
            success : function(res) {
...
function edit(id) {
    ...
    layer_show('编辑','/' + FILE + '/AdminAuthAccess/viewAddEdit?id='+id,800,500);
}
...
function delete_single(id) {
    ...
    $.ajax({
        type : "POST",
        contentType: "application/x-www-form-urlencoded",
        url : '/' + FILE + '/AdminAuthAccess/deleteData',
        data : {
            target:id
        },
        success : function(res) {
